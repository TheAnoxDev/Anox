...
const meta: Record<Locale, { title: string; description: string }> = {
  ...
  fa: { title: "ANOX — زیرساخت هوشمند", description: "ANOX زیرساخت‌ها و تجربه‌های دیجیتال هوشمند در حوزه هوش مصنوعی، امنیت، کلاد و اتوماسیون می‌سازد." },
  ar: { title: "ANOX — البنية التحتية الذكية", description: "تبني ANOX أنظمة رقمية ذكية في الذكاء الاصطناعي والأمن والسحابة والأتمتة." },
  ...
  zh: { title: "ANOX — 智能基础设施", description: "ANOX 专注于人工智能、网络安全、云计算与自动化领域的智能数字系统。" },
};
